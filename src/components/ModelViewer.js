...
const Loader = ({ placeholderSrc }) => {
  ...
  return (
    <Html center>
      <div style={{ color: '#FBF5F3', fontFamily: 'Inter, sans-serif', fontSize: '1.5rem' }}>
        {placeholderSrc ? (
    ...
    >
      {showScreenshotButton && (
        <button
          ...
          onMouseEnter={(e) => {
            e.target.style.background = '#FBF5F3';
            e.target.style.color = '#D7263D';
          }}
          onMouseLeave={(e) => {
            e.target.style.background = '#D7263D';
            e.target.style.color = '#FBF5F3';
          }}
        >
          Screenshot
        </button>
